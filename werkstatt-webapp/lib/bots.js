...
export const BOTS = [
  {
    ...
    description:
      "Beschreibe eine Idee – Säp baut die App, speichert sie in Supabase und exportiert sie auf GitHub für Netlify.",
    role: "App-Builder",
    accent: "violet",
    path: "saep",
    viewKey: null,
  ...
  },
  {
    ...
    description:
      "Prüft und bewertet alle Workflow-Schritte deiner Vorgänge. Ergebnisse fließen in Zementa ein.",
    role: "Qualität",
    accent: "emerald",
    path: "werkstatt-webapp",
    viewKey: "checker",
